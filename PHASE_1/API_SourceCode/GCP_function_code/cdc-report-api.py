...
def API(request):
    ...
    return_log["request_time"] = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
    ...
    if trace_id is not None:
        ...
        if start_date is None or end_date is None:
            ...
            local_log["end_point"] = request.url
    ...
    local_log["report_menu"] = report_menu
    local_log["end_point"] = request.url
    local_log["Query Parameters"] = {"start_date": start_date, "end_date": end_date, "location": location, "key_terms": key_terms}
    ...
    return_log["time_spent"] = time_spent
